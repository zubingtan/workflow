export type { Scope, Mem0Config, DreamConfig, ScopeContext, CustomCategory } from './types.ts';
export { DEFAULT_CUSTOM_CATEGORIES } from './types.ts';

export { loadConfig, CONFIG_DIR } from './config/index.ts';

export { SelfHostedMemoryClient } from './client.ts';
export type {
  SelfHostedMemoryClientOptions,
  MemoryFilters,
  MemoryRow,
  MemoryMessage,
} from './client.ts';
...
export { resolveSearchFilters, resolveAddParams } from './memory/scoping.ts';
export {
  formatAge,
  formatMemoryCompact,
  formatMemoryList,
  groupByCategory,
} from './memory/formatting.ts';
...
export type { MemoryClientLike } from './entry.ts';
