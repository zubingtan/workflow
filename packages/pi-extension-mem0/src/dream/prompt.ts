...
1. ORIENT — Call mem0_memory with action "get_all" to list all memories. Count them. Note oldest/newest.
...
2. GATHER TARGETS — Review each memory. Classify as:
   ...
   - REWRITE: vague, first-person, or poorly-worded entries. Use mem0_memory "add" with improved text, then "delete" the old one.
