...
// ── Opt-out (fork: default OFF — self-hosted privacy, D11) ──────────────
// Upstream defaults to ON; this fork defaults to OFF (local deployment,
// no external calls). Set MEM0_TELEMETRY=true to opt back in.
