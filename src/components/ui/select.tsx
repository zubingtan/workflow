...
/**
 * Compatibility wrapper for the editor's existing option-based call sites.
 * The rendered control is still the Base UI Select primitive; only the
 * callback shape remains select-like for the migrated form controls.
 */
function Select({
  children,
  className,
  ...
  return (
    <SelectPrimitive.Portal container={container ?? undefined}>
      <SelectPrimitive.Positioner
        ...
        className="isolate z-[1001] pointer-events-auto"
      >
